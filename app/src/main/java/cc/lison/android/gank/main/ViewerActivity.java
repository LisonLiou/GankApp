...
public class ViewerActivity extends AppCompatActivity implements RealmChangeListener,ViewPager.OnPageChangeListener{
    ...
    @Bind(cc.lison.android.gank.R.id.pager)
    ViewPager pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cc.lison.android.gank.R.layout.activity_viewer);
        ...
        toolbar.setNavigationIcon(cc.lison.android.gank.R.drawable.ic_arrow_back_white_24dp);
