...
import cc.lison.android.gank.R;
import cc.lison.android.gank.adapter.BenefitGoodsItemAdapter;
...
import cc.lison.android.gank.service.ImageImproveService;
...
public class BenefitListFragment extends BaseLoadingFragment implements SwipeRefreshLayout.OnRefreshListener,
    ...
    void init_ssp() {
        ...
        //创建广告view
        final String adPlaceID = "2559977";//重要：请填上你的代码位ID,否则无法请求到广告
        AdView adView = new AdView(this.getContext(), adPlaceID);
        //设置监听器
        adView.setListener(new AdViewListener() {
            @Override
            public void onAdReady(AdView adView) {
                Log.e(this.getClass().getName().toString(), "addPlaceId: " + adPlaceID + " onAdReady");
            }
            @Override
            public void onAdShow(JSONObject jsonObject) {
                Log.e(this.getClass().getName().toString(), "addPlaceId: " + adPlaceID + " onAdShow");
            }
            @Override
            public void onAdClick(JSONObject jsonObject) {
                Log.e(this.getClass().getName().toString(), "addPlaceId: " + adPlaceID + " onAdClick");
            }
            @Override
            public void onAdFailed(String s) {
                Log.e(this.getClass().getName().toString(), "addPlaceId: " + adPlaceID + " onAdFailed");
            }
            @Override
            public void onAdSwitch() {
                Log.e(this.getClass().getName().toString(), "addPlaceId: " + adPlaceID + " onAdSwitch");
            }
        });
        ...
        mLinearLayout.addView(adView, rllp);
    }
