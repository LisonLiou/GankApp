...
package cc.lison.android.gank.adapter;
...
import cc.lison.android.gank.view.RadioImageView;
...
public abstract class BenefitGoodsItemAdapter extends ArrayRecyclerAdapter<Image, BenefitGoodsItemAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(cc.lison.android.gank.R.layout.benefit_goods_item_layout, parent);
    }
    ...
    private void loadGoodsImage(ViewHolder holder, Image imgGoods) {
        if (null == imgGoods || TextUtils.isEmpty(imgGoods.getUrl())) {
            Glide.with(context)
                    .load(cc.lison.android.gank.R.drawable.item_default_img)
